...
return [
    'title'         => [
        ...
        'default'     => __( 'Lithuania Post - Delivery to overseas', 'woo-lithuaniapost' ),
        'desc_tip'    => true,
    ],
    'fictional_size'          => [
    ...
    'delivery_method'          => [
        ...
        'options'       => [
            ...
            'SMALL_CORESPONDENCE_TRACKED'   => __( 'Corespondence Tracked', 'woo-lithuaniapost' ),
            'MEDIUM_CORESPONDENCE_TRACKED'  => __( 'Corespondence Tracked', 'woo-lithuaniapost' )
        ],
    ],
    'delivery_time' => [
