...
class Woo_Lithuaniapost_Shipping_Lpexpress_Postoffice extends WC_Shipping_Method
{
    /**
    ...
    {
        $this->id                 = 'woo_lithuaniapost_lpexpress_postoffice';
        $this->instance_id        = absint( $instance_id );
        $this->method_title       = __( 'LP EXPRESS - Delivery to post office', 'woo-lithuaniapost' );
        $this->method_description = __( 'LP EXPRESS - Post office shipping method.', 'woo-lithuaniapost' );
        $this->supports           = [
            'shipping-zones',
            'instance-settings',
        ];
    ...
    {
        $this->instance_form_fields = include __DIR__ . '/includes/settings-lpexpress-postoffice.php';
